        ...
        <section className='main-section'>
          ...
          <div className='form-part'>  
            ...
            <form onSubmit={handleSubmit(handleForm)} className='form'   >
              ...
              {errors.firstName && <p className='errMess'> {errors.firstName.message}</p>}
              ...
              {errors.lastName && <p className='errMess'> {errors.lastName.message}</p>}
              ...
              <input type="password" id='ConfirmPass'  placeholder='Confirm password' {...register("confirmPass" , {validate:(val) => val === getValues("password") || "Unmatched password"})}  />
            ...
            { registrationSuccess && <p className="ThankMessage" >thank you for your registration, now <Link to="/Sign-in">Login</Link></p>}
